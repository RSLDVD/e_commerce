import 'package:flutter/material.dart';
 ...
 ThemeData customLightTheme() {
  ...
  return lightTheme.copyWith(appBarTheme: AppBarTheme(backgroundColor:const Color(0XFFeeeeee), color: Colors.black  ),
...
ThemeData customDarkTheme() {
  ...
  return darkTheme.copyWith(
    ...
    // ignore: deprecated_member_use
    cursorColor: Colors.green, colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xFFFFF8E1)),
  );
}
